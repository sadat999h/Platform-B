...
app.get('/api/stream/:videoId', async (req, res) => {
  try {
    ...
    console.log('Header security:', req.headers['x-security-string']);
    console.log('Security string used:', securityString);
    console.log('Master security string:', MASTER_SECURITY_STRING);
    console.log('Match:', securityString === MASTER_SECURITY_STRING);
    console.log('======================');
    ...
    if (securityString !== MASTER_SECURITY_STRING) {
      console.error('Security string mismatch');
      console.error('Received:', securityString);
      console.error('Expected:', MASTER_SECURITY_STRING);
